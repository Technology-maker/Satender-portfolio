    ...
    <section id='about' className="py-0 flex flex-col md:flex-row items-center justify-center mt-1 bg-[#A7A2A9] rounded-md min-h-[450px]">
      ...
      <div className="md:w-1/2 w-full p-4 flex items-center justify-center min-h-[220px]">
        <div className="w-full max-w-xl">
          ...
          <a href="/Satender-CV.pdf" download className="inline-flex items-center gap-2 bg-[#8245ec] text-white px-5 py-2 rounded-md font-semibold shadow hover:bg-[#6d36c9] transition-colors duration-200 border-slate-700 border-2"> <MdFileDownload className="text-xl" />
            Download Resume
          </a>
        </div>
      </div>
